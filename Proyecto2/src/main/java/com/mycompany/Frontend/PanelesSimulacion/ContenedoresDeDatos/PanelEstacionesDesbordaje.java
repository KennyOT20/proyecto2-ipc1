...
import com.mycompany.Frontend.PanelesSimulacion.PanelesDeInformacion.PanelInfoDesbordaje;
 ...
 * @author Kenny
 */
public class PanelEstacionesDesbordaje extends javax.swing.JPanel {

    private final PanelSimulacion panelSimulacion;
    
    /**
     * Creates new form PanelEstacionesDesbordaje
     * @param panelSimulacion
     */
    public PanelEstacionesDesbordaje(PanelSimulacion panelSimulacion) {
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("ESTACIONES DE DESBORDAJE");
        ...
        panelTituloLayout.setVerticalGroup(
            panelTituloLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(labelTitulo, javax.swing.GroupLayout.DEFAULT_SIZE, 78, Short.MAX_VALUE)
        );

        panelCuadricula.setBackground(new java.awt.Color(204, 255, 204));
    ...
    public void cargarCuadricula() {
        try {
            ...
            ListaGenerica<EstacionDesbordaje> estaciones =
                    aeropuerto.getEstacionDesborde();

            for (int i = 0; i < estaciones.getTamañoDeLista(); i++) {
                EstacionDesbordaje estacion = estaciones.obtenerContenido(i);

                PanelInfoDesbordaje panel = new PanelInfoDesbordaje(estacion);
                panelCuadricula.add(panel);
            }

            int columnas = 3;
            int filas = (int) Math.ceil(
                    estaciones.getTamañoDeLista() / (double) columnas
            );
